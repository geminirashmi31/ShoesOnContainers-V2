...
namespace ProductCatalogAPI.Data
{
    public class CatalogSeed
    {
        public static void Seed(CatalogContext context)
        {
            ...
            {
                context.CatalogBrands.AddRange(GetPreConfiguratedCatalogBrands());
                context.SaveChanges();
            }

            if (!context.CatalogTypes.Any())
            {
                context.CatalogTypes.AddRange(GetPreConfiguratedCatalogTypes());
                context.SaveChanges();
            }

            if (!context.CatalogItems.Any())
            {
                context.CatalogItems.AddRange(GetPreConfiguratedItems());
                context.SaveChanges();
            }
        ...
        private static IEnumerable<CatalogItem> GetPreConfiguratedItems()
        {
